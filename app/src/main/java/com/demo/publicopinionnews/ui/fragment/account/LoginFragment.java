...
public class LoginFragment extends BaseBackFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.demo.publicopinionnews.R.layout.fragment_login, container, false);
    ...
    private void initView(View view) {
        ...
        mBtnLogin = (Button) view.findViewById(com.demo.publicopinionnews.R.id.btn_login);
        mBtnRegister = (Button) view.findViewById(com.demo.publicopinionnews.R.id.btn_register);

        toolbar.setTitle(com.demo.publicopinionnews.R.string.login);
