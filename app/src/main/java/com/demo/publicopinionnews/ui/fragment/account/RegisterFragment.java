package com.demo.publicopinionnews.ui.fragment.account;
...
public class RegisterFragment extends BaseBackFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.demo.publicopinionnews.R.layout.fragment_register, container, false);
        initView(view);
        return view;
    }

    private void initView(View view) {
        Toolbar toolbar = (Toolbar) view.findViewById(com.demo.publicopinionnews.R.id.toolbar);
        mEtAccount = (EditText) view.findViewById(com.demo.publicopinionnews.R.id.et_account);
        mEtPassword = (EditText) view.findViewById(com.demo.publicopinionnews.R.id.et_password);
        mEtPasswordConfirm = (EditText) view.findViewById(com.demo.publicopinionnews.R.id.et_password_confirm);
        mBtnRegister = (Button) view.findViewById(com.demo.publicopinionnews.R.id.btn_register);

        showSoftInput(mEtAccount);

        toolbar.setTitle(com.demo.publicopinionnews.R.string.register);
