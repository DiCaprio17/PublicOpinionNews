...
public class DetailFragment extends BaseBackFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.demo.publicopinionnews.R.layout.fragment_detail, container, false);
        initView(view);
    ...
    private void initView(View view) {
        mToolbarLayout = (CollapsingToolbarLayout) view.findViewById(com.demo.publicopinionnews.R.id.toolbar_layout);
        mToolbar = (Toolbar) view.findViewById(com.demo.publicopinionnews.R.id.toolbar);
        FloatingActionButton fab = (FloatingActionButton) view.findViewById(com.demo.publicopinionnews.R.id.fab);
    ...
    private void initLazyView() {
        mToolbarLayout.setCollapsedTitleTextAppearance(com.demo.publicopinionnews.R.style.Toolbar_TextAppearance_White);
        mToolbarLayout.setExpandedTitleTextAppearance(com.demo.publicopinionnews.R.style.Toolbar_TextAppearance_Expanded);
