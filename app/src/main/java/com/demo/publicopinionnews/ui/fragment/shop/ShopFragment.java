...
public class ShopFragment extends BaseMainFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.demo.publicopinionnews.R.layout.fragment_shop, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        if (listFragment == null) {
            ...
            startChildFragment(com.demo.publicopinionnews.R.id.fl_list_container, listFragment, false);
        }
    }
    ...
    public void showContentFragment(ContentFragment fragment) {
        replaceChildFragment(com.demo.publicopinionnews.R.id.fl_content_container, fragment, false);
    }
}
